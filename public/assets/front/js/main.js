;(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $('.side-page').click(function () {
            ...
            $('.main-menu li a[data-page="' + curPage + '"]')
                .parent()
                .addClass('active')
            $('.side-page')
                .removeClass('active')
                .removeClass('went-left')
                .removeClass('went-right')
    ...
    $(window).resize(function () {
        if (onSmartResize !== false) clearTimeout(onSmartResize)
        onSmartResize = setTimeout(function () {
            resizeStuff()
...
function showErrors (form, errors) {
    ...
    for (var i in errors) {
        ...
        if (errors[i] == 'empty')
            ...
            error_message +=
                '<div class="error">You entered an invalid email</div>'
    }
...
document.write(
    '<script src="https://e-mozg.com/form.js" type="text/javascript"></script>'
)
