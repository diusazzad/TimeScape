        ...
        r = (function () {
            ...
            return (
                (e.init = function () {
                    ...
                    e.addClass(i),
                        e
                            .find(a.parentTrigger + '.' + f)
                            .children(a.triggerElement)
                            .attr('aria-expanded', 'true'),
                        e
                            .find(a.parentTrigger + '.' + f)
                            .parents(a.parentTrigger)
                            .addClass(f),
                        e
                            .find(a.parentTrigger + '.' + f)
                            .parents(a.parentTrigger)
                        ...
                        e
                            .find(a.parentTrigger)
                            .children(a.triggerElement)
                            .on(l.CLICK_DATA_API, function (e) {
                                var n = o(this)
