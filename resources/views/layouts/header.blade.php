        ...
        <ul class="navbar-right d-flex list-inline float-right mb-0">
            ...
            <li class="dropdown notification-list d-none d-md-block">
                ...
                <div class="dropdown-menu dropdown-menu-right language-switch">
                    ...
                    <a class="dropdown-item" href="#"><img src="{{ asset('assets/images/flags/italy_flag.jpg') }}"
                    ...
                    <a class="dropdown-item" href="#"><img src="{{ asset('assets/images/flags/russia_flag.jpg') }}"
                ...
                <div class="dropdown notification-list nav-pro-img">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        {{-- <a class="dropdown-item d-block" href="#"><span
                                class="badge badge-success float-right">11</span><i class="mdi mdi-settings m-r-5"></i>
                            Settings</a> --}}
                        <a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5"></i> Lock
                            screen</a>
                        <div class="dropdown-divider"></div>
                        <a class=""><i class="mdi mdi-power text-danger"></i> </a>
