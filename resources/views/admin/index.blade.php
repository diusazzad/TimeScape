...
@section('breadcrumb')
    <div class="col-sm-6 text-left">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">Welcome to TimeSpace Attendance System</li>
        </ol>
    </div>
@endsection
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h4 class="font-500"><i class="text-danger ml-2"></i></h4>
                        <span class="peity-donut"
                            data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72"
                            data-height="72"></span>
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h4 class="font-500"><i class=" text-success ml-2"></i></h4>
                        <span class="peity-donut"
                            data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72"
                            data-height="72"></span>
